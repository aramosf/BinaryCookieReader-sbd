...
#                                                                               #
#*******************************************************************************#
# Netscape output format added by @aramosf || Oct/2013 
...
for page in pages:
	...
	for offset in cookie_offsets:
		...
		unix_epoch=str(int(expiry_date_epoch))
		...
		print url+'\t'+cookie_httponly+'\t'+path+'\t'+cookie_secure+'\t'+unix_epoch+'\t'+name+'\t'+value
